...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        multiplier_spinbox->setGeometry(QRect(1450, 35, 61, 51));
        QFont font1;
        ...
        multiplier_button->setGeometry(QRect(1440, 90, 80, 24));
        multiplier_text = new QLabel(centralwidget);
        multiplier_text->setObjectName(QString::fromUtf8("multiplier_text"));
        multiplier_text->setGeometry(QRect(1400, 10, 151, 22));
        QFont font2;
        font2.setPointSize(12);
        multiplier_text->setFont(font2);
        ...
        platform_stay_spinbox->setGeometry(QRect(1275, 35, 71, 51));
        ...
        platform_stay_text->setGeometry(QRect(1230, 10, 161, 22));
        platform_stay_text->setFont(font2);
        ...
        platform_stay_button->setGeometry(QRect(1270, 90, 80, 24));
        mine_duration_text = new QLabel(centralwidget);
        mine_duration_text->setObjectName(QString::fromUtf8("mine_duration_text"));
        mine_duration_text->setGeometry(QRect(1230, 115, 161, 22));
        mine_duration_text->setFont(font2);
        ...
        mine_duration_button->setGeometry(QRect(1270, 195, 80, 24));
        ...
        mine_duration_spinbox->setGeometry(QRect(1275, 140, 71, 51));
        ...
        train_speed_text->setGeometry(QRect(1400, 115, 151, 22));
        train_speed_text->setFont(font2);
        ...
        train_speed_spinbox->setGeometry(QRect(1450, 140, 61, 51));
        ...
        train_speed_button->setGeometry(QRect(1440, 195, 80, 24));
        ...
        train_interval_spinbox->setGeometry(QRect(1140, 140, 61, 51));
        ...
        train_interval_text->setGeometry(QRect(1090, 115, 151, 22));
        train_interval_text->setFont(font2);
        ...
        train_interval_button->setGeometry(QRect(1130, 195, 80, 24));
        ...
        train_speed_desc->setFont(font2);
